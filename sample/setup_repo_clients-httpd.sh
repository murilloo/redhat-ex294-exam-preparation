...
ansible all -m yum_repository -a "description=baseos file=baseos name=baseos baseurl=http://control.example.com/ enabled=1 gpgcheck=0"
ansible all -m yum_repository -a "description=appstream file=appstream name=appstream baseurl=http://control.example.com/ enabled=1 gpgcheck=0"
